...
Global $N = 21
Global $type[$N+1]
$toolbar = GuiCreate("Choose Control Type", 150, 370, 10, @DesktopHeight/2-175, 0x00C00000, -1, $main)
...
$code = "; Script generated by AutoBuilder 0.6 Prototype" & @CRLF & @CRLF & "#include <GuiConstants.au3>" & @CRLF & @CRLF
